...
import SistemaIluminacion from '../models/SistemaIluminacion.js';

/** Métodos para el CRUD */

// Método para mostrar todos los sistemas de iluminación existentes
export const getAllSistemasIluminacion = async (req, res) => {
  try {
...
export const getSistemaIluminacion = async (req, res) => {
  try {
...
export const createSistemaIluminacion = async (req, res) => {
  try {
...
export const editSistemaIluminacion = async (req, res) => {
  try {
    const id = req.params.id;
...
export const deleteSistemaIluminacion = async (req, res) => {
  try {
    const id = req.params.id;
